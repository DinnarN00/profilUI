            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  text("Dinnar Nurhuda Hermawan", 32),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("dinnar.065119213@unpak.ac.id", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("dinnar.065119213@unpak.ac.id", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("085773643303", 16),
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: const <Widget>[
                          ...
                          Text(
                              "Kp Cibolang, Desa Ciderum, Kecamatan Caringin,     ",
                              style: TextStyle(
                                color: Colors.grey,
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
